...
Note:
* My name's Bianca Power and I'm currently learning web development as a student in Coder Academy's fast track course.
* My background is in education - I have a couple of degrees in education and I spent several years teaching and researching education at Griffith Uni up on the Gold Coast.
* I just turned 30 this year and I'm at the very beginning of my career change into web development, and that's what I'm here to talk with you about today.

* Just a quick detour first though...
* Something I like to do in my spare time is to speedsolve Rubik's cubes and I was asked to do a solve as part of my intro, so here goes...
...
Note:
* So just an overview of my presentation for tonight...
...
Note:
* How does it feel to be new to coding?
...
* all it takes is a tiny typo or one missing bracket and the computer treats you like you didn't even try to speak its language at all
...
Note:
* you also have to learn to think like a programmer, learn to think in the new language that you're learning, while you're learning it
  * basically you have to stop thinking like a normal person, and start thinking like a programmer
* writing pseudo code is definitely helpful, because then you're starting off thinking through what you want to do in your native language and then basically translating it into Ruby, but to do that you still have to get your head around the logic involved and saying it in a way that will make sure the computer has the same interpretation of it as you do, and that can be a real challenge
...
Note:
* Has anyone else experienced that feeling, especially when they were first learning to code, when you're given a challenge and it's just like, where do I even start? Just feeling completely lost, almost like your brain seizes up and you're just floating there in space going "uhhhhhhhh....."
...
* but if it's just between you and Google, getting to the point where you're typing in the right key words can absolutely be a challenge in itself
...
* and it makes it difficult to make informed decisions on which way to go with something, especially when pressed for time
  ...
  * The other thing I completely misestimated was creating a contact form in rails. With no idea how to do it I went in thinking "oh yeah that can't be too hard". Yeah nah. I was wrong.
...
Note:
* Error message anxiety. Now you can trust me on this one... I have a PhD, so I am a Dr... Error message anxiety is a very serious condition experienced by newbie developers, known to affect quality of life and of code, and to induce the fight or flight response in its sufferers.

Error message pops up, eyes glaze over, and you call for help, "knowing" that you have no idea how to fix the error... and you haven't even read the error message.
...
* A couple of other online sources that I've found myself using repeatedly are:
  ...
  * Shortcut Foo's cheatsheets
    * they have some fantastic cheatsheets on things like Ruby Arrays, Strings, Hashes, and even things like the Atom text editor
      * they're a great easy reference point for syntax and how to do simple things that particularly as a beginner I haven't internalised yet
  * Codewars
    ...
    * I've found it's a great way to do more coding than I otherwise might
      * there are a lot of really interesting challenges up there, and you can look through and find ones that you're interested in and have the skillset for
...
* I think one of the best resources is actually talking to other people and listening to other people
  * Meetups
    * I've found going to meetups to be really valuable, even when 90% of the content is over my head, there's still that 10% where I'm at least getting a surface level understanding of it and it's really interesting and motivates to learn more
  * Talking to people
    * Talking to people is a great way to find things out, get introduced to new things, and get new perspectives on things
  * Coder Academy
    * has really been the best resource, for me
    * it's sort of a resource of resources I guess...
      * but yeah, the course content, the access to professionals in the field, and working with classmates have all been invaluable to my learning thus far
...
* You need to...
  ...
  * Break stuff
    * that's really a huge part of programming and the sooner you get used to it the better, because as a programmer you're pretty much always going to be existing in a broken state - well, your code is - because that's the idea.
      * your job is to write code and make stuff work, which means you're working with stuff that's broken by default
    * but seriously it's through getting in and trying things and breaking stuff that we actually learn deeply as coders
...
Note:
* Love to learn
  * if you have an interest in learning for its own sake, you're automatically going to be a better learner because you're going to be more engaged, you're going to go deeper into topics simply because you can't help yourself, and you're going to enjoy the learning process a lot more - and when we are engaged and interested and enjoy what we're doing, we learn better
  * as a side note, for me as a lifelong learner, a love of learning is one of the reasons I'm drawn to programming, because it's an area where you actually do need to keep learning constantly as part of your work

* Make it interesting
  * working on something you have an interest in means that you'll be more engaged with what you're doing, and more likely to follow the sort of tangents that can lead to better understandings and learning how to do really awesome things
    * leveraging the power of gems is, I think, a fantastic way to make really cool things very early on in your Ruby career.
    * there's so much you can do with them and I mean what you're doing is leveraging code that other people have written, but doing it in such a way that you still understand what your core program is doing, and that's really cool and really powerful
...
* Gamification
  ...
  * Gamification is something that really taps into the nature of how we as humans engage with things, so it can be really effective for a lot of people
...
* Teach others
  ...
  * because it forces you to articulate your understanding, which requires you to think about it in different ways
...
* Learn from others
  * 30 of us in the same class, all exposed to the same information, will each come away having a slightly different understanding of what we learnt
  ...
  * going to meetups and talks, and actually listening and engaging with them is another great way to learn from others
